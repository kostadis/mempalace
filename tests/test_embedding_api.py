...
class _FakeCfg:
    def __init__(self, url=None, model=None, key=None, embedding_model="openai-compat"):
        ...
        # Local's provider-first design (divergence.md's embedding-selection unification) checks this
        # before ever looking at embedding_model; "onnx" (real
        # MempalaceConfig's own default) falls through to the upstream
        # model-based openai-compat selector these tests exercise.
        self.embedding_provider = "onnx"
