...
A **palace** is one physical directory with its own storage backend, knowledge graph, and entity registry. You can have many — for example, one per project — and they never share data.
